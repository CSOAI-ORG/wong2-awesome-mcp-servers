...
- **[meok-omnibus-tracker-mcp](https://github.com/CSOAI-ORG/MEOK-LABS/tree/main/mcps/meok-omnibus-tracker-mcp)** - Live status of every EU AI Act Digital Omnibus provision after the 569-45-23 Parliament vote on 23 March 2026.
- **[meok-watermark-attest-mcp](https://github.com/CSOAI-ORG/MEOK-LABS/tree/main/mcps/meok-watermark-attest-mcp)** - EU AI Act Article 50 transparency / watermarking compliance MCP for the 2 Nov 2026 cliff (5-language disclosure templates per surface).
- **[meok-cra-annex-iv-classifier-mcp](https://github.com/CSOAI-ORG/MEOK-LABS/tree/main/mcps/meok-cra-annex-iv-classifier-mcp)** - EU CRA product classifier (default / Class I / Class II / Annex IV per Implementing Reg 2025/2392).
- **[meok-nis2-de-register-mcp](https://github.com/CSOAI-ORG/MEOK-LABS/tree/main/mcps/meok-nis2-de-register-mcp)** - German Mittelstand BSI portal NIS2 registration packet generator with signed proof.
- **[meok-mcp-injection-scan-mcp](https://github.com/CSOAI-ORG/MEOK-LABS/tree/main/mcps/meok-mcp-injection-scan-mcp)** - 30+ canonical scan rules covering the April 2026 Anthropic MCP RCE class, mcp-server-git CVE chain, and OWASP LLM Top 10 — issues procurement-grade signed safety reports.
- **[meok-dpia-edpb-template-mcp](https://github.com/CSOAI-ORG/MEOK-LABS/tree/main/mcps/meok-dpia-edpb-template-mcp)** - DPIA generator for the EDPB harmonised template (adopted 14 Apr 2026) with EU AI Act Article 26(9) FRIA mapping baked in.
